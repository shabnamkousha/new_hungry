...
@property (nonatomic, readonly, copy) NSString *businessid;

@property (nonatomic, readonly,nullable, copy) NSArray<NSString *> *is_overnight;

@property (nonatomic, readonly,nullable, copy) NSArray<NSString *> *start;

@property (nonatomic, readonly,nullable, copy) NSArray<NSString *> *end;
